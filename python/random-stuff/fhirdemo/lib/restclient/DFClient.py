...
import json
import requests
from lib.utilities.log import log, create_log_file
...
from fhir.resources.practitioner import Practitioner, codeableconcept, period, humanname, identifier, fhirdate, \
    contactpoint
...
class DFClient(object):
    ...
    def patient_read(self, mongo_id):
        ...
        try:
            ...
            log(self.log_file, "Error Patient,  -> exception msg: " + str(e) + "\n")
            log(self.log_file,
    ...
    def careteam_read(self, mongoid):
        ...
        try:
            ...
            log(self.log_file, "Error Careteam,  -> exception msg: " + str(e) + "\n")
            log(self.log_file,
    ...
    def carecoach_read(self, mongoid):
        ...
        try:
            ...
            log(self.log_file, "Error CareCoach,  -> exception msg: " + str(e) + "\n")
            log(self.log_file,
