...
class EotClient(object):
    counter: int = 0
    jdc_str: str = 'jdbc:sqlserver://dmdsql03.corp.catasys.com:1433;DatabaseName=eot_coachnote'
    server_name: str = 'dmdsql03.corp.catasys.com'
    db_name: str = 'eot_coachnote'
    username: str = 'coachnote'
    password: str = ''
